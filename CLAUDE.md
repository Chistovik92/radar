...
Текущая версия — 4.7.5.4, она же выложена на GitHub.
...
1. **Номер — следующий за существующим.** После 4.7.5.3 идёт 4.7.5.4,
   а не 4.7.6. Формат от двух до четырёх чисел: мелкая правка или
   исправление бага — четвёртый разряд (`X.Y.Z.W`).
