...
Текущая версия — 4.7.6.5, она же выложена на GitHub.
...
3. **Номер правится разом везде:** `radar/__init__.py`, `README.md`,
   `README.en.md`, `docs/STATUS.md` (строка в истории версий) и этот
   файл. Установщик пересобирается после смены номера.
