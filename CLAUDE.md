...
Текущая версия — 4.9.8.12, она же выложена на GitHub.
...
1а. **Пока идёт доводка панели — только четвёртый разряд 4.9.8.X.**
   Работы по дорожной карте приостановлены, и всё, что выходит до их
   возобновления, нумеруется 4.9.8.1, 4.9.8.2 и так далее. Третий разряд
   (4.9.9) открывается только вместе с возвратом к дорожной карте.
