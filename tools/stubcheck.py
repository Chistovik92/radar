...
def main() -> int:
    ...
    modules = [
        ...
        "radar.identity", "radar.features", "radar.logs", "radar.presets", "radar.sourcecheck", "radar.sos", "radar.media", "radar.secrets", "radar.aibench", "radar.proxy", "radar.provider", "radar.digest", "radar.quiet", "radar.backup", "radar.profiling", "radar.astro",
        ...
        "radar.handlers.sources", "radar.handlers.users", "radar.handlers.features", "radar.handlers.logs", "radar.handlers.sos", "radar.handlers.media", "radar.handlers.settings_admin", "radar.handlers.network", "radar.handlers.digest", "radar.handlers.perf", "radar.handlers.assistant",
